-- OBJECTIF DE CE SCRIPT : échantillonnage de la BDD
-- Ajout de "fausses" données de tests
-- On n'exécuterait pas ce script en production : en production, c'est Nicole qui créé véritablement ses listes et ses cartes. 
-- Dans une optique de dev, c'est pratique d'avoir déjà des choses en BDD à afficher !
